...
from segnet import get_segnet_basic_17, get_segnet_basic_52, preprocess,dice_coef, dice_coef_loss
import numpy as np
...
path = '/Users/xuchenyang/Documents/third_exp/file/segnet-52-lr-2-32-100/'
...
def predict():
    ...
    path_to_save_results= path+"SEGNET_PREDICTIONS/"
    ...
    print('-'*30)
    model.load_weights(path+'segnet.hdf5')
